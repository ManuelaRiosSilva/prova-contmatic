...
public final class EnderecoConstante {
	...
	public static final String CEP_MENSAGEM_NULO = "O campo CEP do Endereço é obrigatório.";
	
	public static final String CEP_MENSAGEM_VAZIO = "O campo CEP do Endereço não pode estar vazio.";
	...
	public static final String LOGRADOURO_MENSAGEM_VAZIO= "O campo Logradouro do Endereço não pode estar vazio.";
	...
	public static final String UF_MENSAGEM_VAZIO = "O campo UF do Endereço não pode estar vazio.";
