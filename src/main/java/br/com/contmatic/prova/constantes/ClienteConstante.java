...
public final class ClienteConstante {
	...
	public static final String CPF_MENSAGEM_CARACTERES_INVALIDOS = "O campo CPF do Cliente deve conter somente números.";
	...
	public static final String NOME_MENSAGEM_CARACTERES_INVALIDOS = "O campo Nome do Cliente deve conter somente letras.";
