...
public abstract class Auditoria {
    ...
    @Pattern(regexp = REGEX_PERMITIR_SOMENTE_LETRAS, message = CRIADO_POR_MENSAGEM_CARACTERES_INVALIDOS)
    ...
    @Pattern(regexp = REGEX_PERMITIR_SOMENTE_LETRAS, message = ATUALIZADO_POR_MENSAGEM_CARACTERES_INVALIDOS)
